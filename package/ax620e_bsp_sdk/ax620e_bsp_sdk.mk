...
TINYALSA_CUSTOM_VERSION = 2.0.0_P7

TINYALSA_CUSTOM_TARBALL = $(call qstrip,$(call github,AXERA-TECH,ax620e_bsp_sdk,v$(TINYALSA_CUSTOM_VERSION))/ax620e_bsp_sdk-$(TINYALSA_CUSTOM_VERSION).tar.gz)
