...
[ -d 'build_AX630C_LITE_ubuntu22_04_V3.0.0_20241120230136' ] || mkdir -p build_AX630C_LITE_ubuntu22_04_V3.0.0_20241120230136/ubuntu-base-22.04.5-base-arm64
./creat_AX630C_LITE_buildroot_image_V3.0.0_20241120230136.sh && sudo cp build_AX630C_LITE_buildroot_V3.0.0_20241120230136/buildroot/output/axera-image build_AX630C_LITE_ubuntu22_04_V3.0.0_20241120230136/ -a
[ -d 'build_AX630C_LITE_ubuntu22_04_V3.0.0_20241120230136/axera-image' ] || { echo "not found axera-image" && exit -1; }

pushd build_AX630C_LITE_ubuntu22_04_V3.0.0_20241120230136
...
sudo tar zxf ../../board/m5stack/V3.0.0_20241120230136_soc.tar.gz -C rootfs/soc
[ -f "../../board/m5stack/V3.0.0_20241120230136_opt.tar.gz" ] && sudo tar zxf ../../board/m5stack/V3.0.0_20241120230136_opt.tar.gz -C rootfs/opt
