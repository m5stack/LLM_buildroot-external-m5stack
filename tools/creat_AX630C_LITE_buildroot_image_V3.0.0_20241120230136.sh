...
clone_buildroot() {
    ...
    [ -f '../../../board/m5stack/V3.0.0_20241120230136_opt.tar.gz' ] || wget https://github.com/m5stack/LLM_buildroot-external-m5stack/releases/download/v0.0.0/V3.0.0_20241120230136_opt.tar.gz -O ../../../board/m5stack/V3.0.0_20241120230136_opt.tar.gz
    popd
}
