...
sudo tar -zxpf $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS -C $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME
...
sudo cp ../../board/m5stack/module_LLM/overlay/usr/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/usr/ -a
sudo cp --preserve=mode,timestamps -rf ../overlay_ubuntu22_04/* $BR2_M5STACK_BSP_SUPPORT_UBUNTU_ROOTFS_NAME/
